...
class App {
  ...
  _setRenderer() {
    ...
    this.renderer.setClearColor(0xcdced3, 1.0);
  ...
  _setLight() {
    ...
    this.directionalLight = new THREE.DirectionalLight(0xffffff, 0.52);
  ...
  _setMainBall() {
    ...
    this.mainGeometory = new THREE.IcosahedronGeometry(10, 20);
  ...
  _setPlane() {
    ...
    this.texture = this.loader.load("https://images.unsplash.com/photo-1494894194458-0174142560c0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80");
    const uniforms = {
      uTime: { value: 0.0 },
      uColor: { value: new THREE.Color(0xffffff) },
      uGlossiness: { value: 5 },
    };
    this.planeGeo = new THREE.PlaneGeometry(1, 1, 100, 100);
  ...
  render() {
    ...
    this.planeMesh.material.uniforms.uTime.value += 0.001;
